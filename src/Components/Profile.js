      ...
      <div class='row'>
        <div class='col-3 profile-body-left'>
          <div className='profile-body-left-header'>
            ...
            <Link to='/login'><button className="btn btn-outline-secondary mt-15 padding-l-15 padding-r-15" type="submit">Change Avatar</button></Link>
          </div>
        ...
        <div class='col-9 profile-body-right'>
          <div style={{ padding: '30px' }}>
            ...
            <input type="text" class="form-control mb-3 input-Fields" id="FirstName" placeholder="First Name" />
            <label className='mb-3'>Last Name</label>
            <input type="text" class="form-control mb-3 input-Fields" id="LastName" placeholder="Last Name" />
            <label className='mb-3'>Email Address</label>
            <input type="text" class="form-control mb-3 input-Fields" id="EmailAddress" placeholder="Email Address" />
            <label className='mb-3'>Phone Number</label>
            <input type="text" class="form-control mb-3 input-Fields" id="PhoneNumber" placeholder="Phone Number" />
